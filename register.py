...
def Register():
    ...
    name_entry = tk.Entry(frame ,font=('Arial',12,'normal'), bg='#87CEEB')
    name_entry.bind("<Return>", database)
    email_entry = tk.Entry(frame,font=('Arial',12,'normal'), bg='#87CEEB')
    email_entry.bind("<Return>",database)
    mobile_entry = tk.Entry(frame,font=('Arial',12,'normal'), bg='#87CEEB')
    mobile_entry.bind("<Return>",database)
    username_entry = tk.Entry(frame,font=('Arial',12,'normal'), bg='#87CEEB')
